...
final class TopicLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        let availableSpace = collectionView.frame.width - lineInsets
        let cellWidth = availableSpace / CGFloat(itemsInRow)
