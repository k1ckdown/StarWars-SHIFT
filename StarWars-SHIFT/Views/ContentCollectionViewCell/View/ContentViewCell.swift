...
final class ContentViewCell: UICollectionViewCell, ReuseIdentifier {
    ...
    private func setupMainTitleLabel() {
        ...
        mainTitleLabel.font = .mainTitle
        mainTitleLabel.backgroundColor = .appWhite
    ...
    private func setupSubTitleLabel() {
        ...
        subTitleLabel.backgroundColor = .appWhite
